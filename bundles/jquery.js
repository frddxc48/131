!function(n, t) {
    ...
    function lr(n, t, r) {
        ...
        if (void 0 === r && 1 === n.nodeType)
            if (u = "data-" + t.replace(cr, "-$&").toLowerCase(),
            r = n.getAttribute(u),
            "string" == typeof r) {
                try {
    ...
    function b(n, t, u, e) {
        ...
        if (k || v > 1 && "string" == typeof y && !f.checkClone && ie.test(y))
            return n.each(function(i) {
                var r = n.eq(i);
                k && (t[0] = y.call(this, i, r.html()));
                b(r, t, u, e)
            });
        if (v && (l = kr(t, n[0].ownerDocument, !1, n, e),
        p = l.firstChild,
        1 === l.childNodes.length && (l = p),
        p || e)) {
            for (c = i.map(o(l, "script"), fe),
            a = c.length; v > h; h++)
                s = l,
                h !== d && (s = i.clone(s, !0, !0),
            ...
            if (a)
                ...
                h = 0; a > h; h++)
                    s = c[h],
                    wr.test(s.type || "") && !r.access(s, "globalEval") && i.contains(w, s) && (s.src ? i._evalUrl && i._evalUrl(s.src) : i.globalEval(s.textContent.replace(ue, "")))
        }
        return n
    }
    function iu(n, t, r) {
        for (var u, e = t ? i.filter(t, n) : n, f = 0; null != (u = e[f]); f++)
            ...
            u.parentNode && (r && i.contains(u.ownerDocument, u) && ui(o(u, "script")),
    ...
    function oi(n) {
        var r = u
          , t = ei[n];
        return t || (t = ru(n, r),
        "none" !== t && t || (pt = (pt || i("<iframe frameborder='0' width='0' height='0'/>")).appendTo(r.documentElement),
        r = pt[0].contentDocument,
        r.write(),
        r.close(),
        t = ru(n, r),
        pt.detach()),
    ...
    function tt(n, t, r) {
        ...
        !f.pixelMarginRight() && si.test(u) && uu.test(t) && (o = e.width,
        s = e.minWidth,
        h = e.maxWidth,
    ...
    function au(n, t) {
        for (var e, u, s, o = [], f = 0, h = n.length; h > f; f++)
            ...
            "" === u.style.display && ot(u) && (o[f] = r.access(u, "olddisplay", oi(u.nodeName)))) : (s = ot(u),
    ...
    function ce(n, t, u) {
        var f, a, p, v, o, w, h, b, l = this, y = {}, s = n.style, c = n.nodeType && ot(n), e = r.get(n, "fxshow");
    ...
    function l(n, t, r) {
        var e, o, s = 0, a = l.prefilters.length, f = i.Deferred().always(function() {
            ...
            if (o)
                return !1;
            for (var s = it || pu(), t = Math.max(0, u.startTime + u.duration - s), h = t / u.duration || 0, i = 1 - h, r = 0, e = u.tweens.length; e > r; r++)
                u.tweens[r].run(i);
    ...
    var y = [], u = n.document, v = y.slice, gi = y.concat, ni = y.push, ct = y.indexOf, lt = {}, lf = lt.toString, ti = lt.hasOwnProperty, f = {}, nr = "2.2.0", i = function(n, t) {
    ...
    i.extend({
        ...
        makeArray: function(n, t) {
            var r = t || [];
            return null != n && (ii(Object(n)) ? i.merge(r, "string" == typeof n ? [n] : n) : ni.call(r, n)),
            r
        },
        ...
        proxy: function(n, t) {
            ...
            t = n,
            n = u),
            i.isFunction(n) ? (f = v.call(arguments, 2),
            r = function() {
    ...
    i.ready.promise = function(t) {
        return at || (at = i.Deferred(),
        "complete" === u.readyState || "loading" !== u.readyState && !u.documentElement.doScroll ? n.setTimeout(i.ready) : (u.addEventListener("DOMContentLoaded", vt),
        n.addEventListener("load", vt))),
        at.promise(t)
    }
    ;
    i.ready.promise();
        ...
        remove: function(n, t) {
            ...
            if (void 0 !== u) {
                if (void 0 === t)
                    ...
                    for (i.isArray(t) ? r = t.concat(t.map(i.camelCase)) : (e = i.camelCase(t),
                    (t in u) ? r = [t, e] : (r = e,
    ...
    i.fn.extend({
        data: function(n, t) {
            ...
            return "object" == typeof n ? this.each(function() {
                ...
                var r, f;
                if (u && void 0 === t) {
                    if ((r = e.get(u, n) || e.get(u, n.replace(cr, "-$&").toLowerCase()),
                    void 0 !== r) || (f = i.camelCase(n),
                    r = e.get(u, f),
                    void 0 !== r) || (r = lr(u, f, void 0),
                    void 0 !== r))
                        return r
                } else
                    f = i.camelCase(n),
    ...
    i.event = {
        ...
        dispatch: function(n) {
            n = i.event.fix(n);
            var o, s, e, u, t, h = [], c = v.call(arguments), l = (r.get(this, "events") || {})[n.type] || [], f = i.event.special[n.type] || {};
            if (c[0] = n,
        ...
        fix: function(n) {
            ...
            for (t || (this.fixHooks[r] = t = gf.test(r) ? this.mouseHooks : df.test(r) ? this.keyHooks : {}),
    ...
    i.Event = function(n, t) {
        ...
        this.type = n.type,
        this.isDefaultPrevented = n.defaultPrevented || void 0 === n.defaultPrevented && n.returnValue === !1 ? yt : nt) : this.type = n,
        t && i.extend(this, t),
        ...
        if (t.style) {
            ...
            i.extend(f, {
                ...
                reliableMarginRight: function() {
                    ...
                    return i.style.cssText = t.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
    ...
    i.extend({
        ...
        style: function(n, t, r, u) {
            if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
                ...
                "string" === h && (e = et.exec(r)) && e[1] && (r = vr(n, t, e),
                h = "number"),
    ...
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                if (r)
                    return se.test(i.css(n, "display")) && 0 === n.offsetWidth ? hi(n, he, function() {
                        return lu(n, t, u)
                    }) : lu(n, t, u)
            },
            set: function(n, r, u) {
                var f, e = u && wt(n), o = u && cu(n, t, u, "border-box" === i.css(n, "boxSizing", !1, e), e);
                return o && (f = et.exec(r)) && "px" !== (f[3] || "px") && (n.style[t] = r,
                r = i.css(n, t)),
                hu(n, r, o)
            }
        }
    ...
    i.cssHooks.marginLeft = ci(f.reliableMarginLeft, function(n, t) {
        if (t)
            return (parseFloat(tt(n, "marginLeft")) || n.getBoundingClientRect().left - hi(n, {
                marginLeft: 0
            }, function() {
    ...
    i.Animation = i.extend(l, {
        tweeners: {
            "*": [function(n, t) {
                ...
                return vr(i.elem, n, et.exec(t), i),
                i
            }
            ]
        },
    ...
    i.fn.extend({
        ...
        hasClass: function(n) {
            for (var t, r = 0, i = " " + n + " "; t = this[r++]; )
                if (1 === t.nodeType && (" " + k(t) + " ").replace(dt, " ").indexOf(i) > -1)
                    return !0;
            return !1
        }
    });
    ...
    i.fn.extend({
        val: function(n) {
            ...
            "string" == typeof r ? r.replace(gu, "") : null == r ? "" : r)) : void 0
        }
    });
    i.extend({
        valHooks: {
    ...
    i.extend(i.event, {
        trigger: function(t, f, e, o) {
            var w, s, c, b, a, v, l, p = [e || u], h = ti.call(t, "type") ? t.type : t, y = ti.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = c = e = e || u,
            ...
            o || !l.trigger || l.trigger.apply(e, f) !== !1)) {
                if (!o && !l.noBubble && !i.isWindow(e)) {
                    ...
                    li.test(b + h) || (s = s.parentNode); s; s = s.parentNode)
                        p.push(s),
                        c = s;
                ...
                for (w = 0; (s = p[w++]) && !t.isPropagationStopped(); )
                    ...
                    v && v.apply(s, f),
                    v = a && s[a],
                    v && v.apply && g(s) && (t.result = v.apply(s, f),
                    t.result === !1 && t.preventDefault());
                return t.type = h,
                o || t.isDefaultPrevented() || l._default && l._default.apply(p.pop(), f) !== !1 || !g(e) || a && i.isFunction(e[h]) && !i.isWindow(e) && (c = e[a],
                c && (e[a] = null),
                i.event.triggered = h,
                e[h](),
    ...
    i.extend({
        ...
        ajax: function(t, r) {
            function b(t, r, u, h) {
                ...
                tt.fireWith(c, [e, l]),
                y && (g.trigger("ajaxComplete", [e, f]),
                --i.active || i.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (r = t,
            t = void 0);
            r = r || {};
            var v, o, k, p, d, l, y, a, f = i.ajaxSetup({}, r), c = f.context || f, g = f.context && (c.nodeType || c.jquery) ? i(c) : i.event, nt = i.Deferred(), tt = i.Callbacks("once memory"), w = f.statusCode || {}, it = {}, rt = {}, s = 0, ut = "canceled", e = {
                readyState: 0,
            ...
            e.success = e.done,
            e.error = e.fail,
            f.url = ((t || f.url || ht.href) + "").replace(ae, "").replace(pe, ht.protocol + "//"),
            ...
            delete f.data),
            f.cache === !1 && (f.url = nf.test(o) ? o.replace(nf, "$1_=" + ai++) : o + (vi.test(o) ? "&" : "?") + "_=" + ai++));
                ...
                send: function(u, f) {
                    ...
                    i = function(n) {
                        return function() {
                            ...
                            "abort" === n ? e.abort() : "error" === n ? "number" != typeof e.status ? f(0, "error") : f(e.status, e.statusText) : f(of[e.status] || e.status, e.statusText, "text" !== (e.responseType || "text") || "string" != typeof e.responseText ? {
                                binary: e.response
                            } : {
                                text: e.responseText
    ...
    i.ajaxPrefilter("json jsonp", function(t, r, u) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            ...
            s ? t[s] = t[s].replace(gt, "$1" + f) : t.jsonp !== !1 && (t.url += (vi.test(t.url) ? "&" : "?") + t.jsonp + "=" + f),
    ...
    i.parseHTML = function(n, t, r) {
        ...
        var e = rr.exec(n)
          , o = !r && [];
        return e ? [t.createElement(e[1])] : (e = kr([n], t, o),
    ...
    i.fn.load = function(n, t, r) {
        if ("string" != typeof n && di)
            return di.apply(this, arguments);
        var f, o, s, u = this, e = n.indexOf(" ");
        return e > -1 && (f = i.trim(n.slice(e)),
        n = n.slice(0, e)),
        i.isFunction(t) ? (r = t,
    ...
    i.fn.extend({
        offset: function(n) {
            ...
            if (e)
                ...
                i.contains(t, r) ? (u = r.getBoundingClientRect(),
                f = sf(e),
                {
        ...
        position: function() {
            if (this[0]) {
                ...
                t.top += i.css(n[0], "borderTopWidth", !0) - n.scrollTop(),
                t.left += i.css(n[0], "borderLeftWidth", !0) - n.scrollLeft()),
                {
